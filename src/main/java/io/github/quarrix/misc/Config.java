...
public class Config {
    ...
    public Location getLocation(String path) {
        Location l = new Location(Bukkit.getWorld("world"), getConfig().getDouble(path + ".x"), getConfig().getDouble(path + ".y"), getConfig().getDouble(path + ".z"), Float.parseFloat("" + getConfig().getDouble(path + ".yaw")), Float.parseFloat("" + getConfig().getDouble(path + ".pitch")));
        return l;
    }
}